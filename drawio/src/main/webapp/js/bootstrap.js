...
(function()
{
    ...
    if (mxIsElectron)
    {
        mxmeta(null, 'default-src \'self\'; script-src \'self\' \'sha256-6g514VrT/cZFZltSaKxIVNFF46+MFaTSDTPB8WfYK+c=\' ' +
            ...
            'connect-src \'self\' https://*.draw.io https://*.diagrams.net https://fonts.googleapis.com https://fonts.googleapis.cn https://fonts.gstatic.com https://fonts.gstatic.cn; ' +
            'img-src * data:; media-src *; font-src * data:; frame-src \'none\'; style-src \'self\' \'unsafe-inline\' ' +
            'https://fonts.googleapis.com https://fonts.googleapis.cn; base-uri \'none\';child-src \'self\';object-src \'none\';', 'Content-Security-Policy');
    }
})();
