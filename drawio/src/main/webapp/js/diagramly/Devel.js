...
if (!mxIsElectron)
{
	(function()
	{
		...
		var directives = 'connect-src %connect-src% \'self\' https://*.draw.io https://*.diagrams.net ' +
			...
			'https://*.google.com https://fonts.gstatic.com https://fonts.gstatic.cn https://fonts.googleapis.com https://fonts.googleapis.cn https://api.anthropic.com; ' +
			...
			'style-src %style-src% \'self\' https://fonts.googleapis.com https://fonts.googleapis.cn \'unsafe-inline\'; ' +
			'base-uri \'none\'; ' +
			'child-src \'self\'; ' +
			'object-src \'none\';';
